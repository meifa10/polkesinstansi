                    ...
                    <details class="group bg-blue-50 border border-blue-100 rounded-xl overflow-hidden">
                        ...
                        <div class="p-6 bg-white border-t space-y-4">
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                <div class="bg-slate-50 p-2 rounded text-center"><p class="text-[10px] font-bold text-slate-400">BB</p><p class="font-bold">{{ optional($rm->pendaftaran)->berat_badan ?? '-' }} kg</p></div>
                                <div class="bg-slate-50 p-2 rounded text-center"><p class="text-[10px] font-bold text-slate-400">TB</p><p class="font-bold">{{ optional($rm->pendaftaran)->tinggi_badan ?? '-' }} cm</p></div>
