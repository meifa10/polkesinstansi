...
<div class="p-6 bg-slate-100 min-h-screen font-['Plus_Jakarta_Sans'] flex justify-center items-center">
    <div class="w-full max-w-3xl bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
        ...
        <div class="p-8 space-y-8">
            ...
            {{-- TRANSAKSI UTAMA --}}
            <div>
                <h3 class="text-slate-900 font-extrabold text-sm uppercase tracking-wider mb-3">Item Transaksi & Tindakan</h3>
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr>
                            <td class="py-3.5">
                                <p class="font-bold text-slate-800">Obat-obatan & Farmasi</p>
                                <p class="text-xs text-emerald-600 italic font-medium">Resep: {{ $pembayaran->pendaftaran->rekamMedis->resep ?? 'Tidak ada resep obat' }}</p>
                            </td>
                            <td class="py-3.5 text-right font-bold text-slate-900">
                    ...
                    <tfoot>
                        <tr class="border-t-2 border-slate-900">
                            <td class="pt-4 text-base font-black text-slate-900 uppercase">Total Tagihan Bersih</td>
