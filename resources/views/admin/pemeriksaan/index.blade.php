    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 lg:p-8 mb-8">
        <form method="GET" action="{{ route('admin.pemeriksaan') }}" class="grid grid-cols-1 md:grid-cols-12 gap-5 items-end">
            ...
            <div class="md:col-span-2 flex gap-2">
                <button type="submit" class="flex-1 bg-slate-800 text-white py-3.5 rounded-xl font-bold text-base hover:bg-slate-900 transition-colors shadow-md flex items-center justify-center">
                    Cari
                </button>
            ...
            <table class="w-full text-left border-collapse min-w-[1000px]">
                <thead>
                    <tr class="bg-emerald-900 text-white text-sm uppercase tracking-widest font-bold">
                        ...
                        <th class="py-5 px-6 min-w-[200px]">Poliklinik</th>
                    ...
                    <tr class="hover:bg-emerald-50/60 transition-colors group">
                        ...
                        <td class="py-5 px-6 text-center align-middle">
                            <span class="px-3 py-1 bg-emerald-50 text-emerald-700 rounded-full font-extrabold border border-emerald-200 text-sm">
                                {{ $p->rekamMedis->count() }} Kali Periksa
                            </span>
                        </td>
                        <td class="py-5 px-6 text-center align-middle">
                            <a href="{{ route('admin.pemeriksaan.show', $p->id) }}" class="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2.5 rounded-xl text-xs font-extrabold uppercase tracking-wider transition-colors shadow-sm">
