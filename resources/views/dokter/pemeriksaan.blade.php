                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <datalist id="list-icd10">
                                @foreach($masterPenyakit as $p)
                                    <option value="{{ $p->kode_icd10 }} - {{ $p->nama_penyakit }}"></option>
                                @endforeach
                            </datalist>
                        </div>
                ...
                <div class="bg-slate-50 p-5 md:p-6 rounded-2xl border border-slate-200">
                    ...
                    <div id="obat-wrapper" class="space-y-4">
                        <div class="obat-row flex flex-col md:flex-row items-start md:items-end gap-4 p-4 bg-white border border-slate-300 rounded-xl relative transition-all">
                            ...
                            <button type="button" onclick="hapusObat(this)" class="w-full md:w-auto mt-2 md:mt-0 flex items-center justify-center p-3 bg-white text-rose-600 hover:bg-rose-50 rounded-lg transition-colors border border-rose-200 flex-shrink-0">
...
<script>
    ...
    function hapusObat(btn) {
        ...
        if (rows.length > 1) {
            ...
            alert('Minimal harus ada satu baris input obat.');
        }
    }
</script>
